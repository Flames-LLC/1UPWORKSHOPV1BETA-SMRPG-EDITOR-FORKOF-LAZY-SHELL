...
namespace LazyShell.EventScripts
{
    public static partial class Parser
    {
        ...
        public static readonly string[] EventCommands = new string[]
        {
            #region 0x00-0x3F
            "Mario, {0}",			// 0x00
            "Toadstool, {0}",			// 0x01
            ...
            "If {0} is present in current area, jump to ${1}",			// 0x32
            "",			// 0x33
            ...
            "Open area: {0}; place Mario @ ({1},{2},{3},{4}) ({5}, {6})",			// 0x68
            "",			// 0x69
            "Modify layer of area {0}; apply mod #{1} ({2})",			// 0x6A
            "Modify collision of area {0}; apply mod #{1} ({2})",			// 0x6B
            "",			// 0x6C
            "",			// 0x6D
            "",			// 0x6E
            "",			// 0x6F
            ...
            "{2} {0} in area {1}",			// 0xF2
            "{2} event trigger of {0} in area {1}",			// 0xF3
            "Summon object @ $70A8 to current area",			// 0xF4
            "Remove object @ $70A8 from current area",			// 0xF5
            "Enable event trigger for object @ $70A8",			// 0xF6
            "Disable event trigger for object @ $70A8",			// 0xF7
            "If {0} is {1} in area {2}; jump to ${3}",			// 0xF8
        ...
        public static readonly string[] EventCommandsFD = new string[]
        {
            #region 0x00-0x3F
            "","","","","","","","",
            "","","","","","","","",
            ...
            "If {0} event trigger {1} in area {2}; jump to ${3}",			// 0xF0
            "",			// 0xF1
            "",			// 0xF2
            "",			// 0xF3
            "",			// 0xF4
        ...
        private static readonly string[] LayerNames = new string[] 
        { 
            "L1", "L2", "L3", "L4", "Sprites", "BG", "½ intensity", "Minus sub"
        };
        private static readonly string[] TutorialNames = new string[] 
        {
            "How to equip", "How to use items", "How to switch allies", "How to play beetle mania" 
        };
        private static readonly string[] EventNames = new string[] 
        { 
            "Mario falls to pipehouse", "Mario returns to MK", "Mario takes Nimbus bus" 
        };
        ...
        public static string ParseCommand(EventCommand command)
        {
            ...
            switch (command.Opcode)
            {
                case 0x32:
                    ...
                    break;
                case 0x34:
                case 0x35: vars[0] = Bits.GetString(command.Param1, ButtonNames, 8); break;
                case 0x36:
                    vars[0] = (command.Param1 & 0x80) == 0x80 ? "Add" : "Remove";
                    vars[1] = CharacterNames[command.Param1 & 0x1F];
                    break;
                case 0x38: vars[0] = (command.Param1 - 8).ToString(); break;
                case 0x39:
                    vars[0] = ObjectNames[command.Param1];
                    vars[1] = Bits.GetShort(command.Data, 2).ToString("X4");
                    break;
                ...
                case 0x3B:
                    ...
                    vars[3] = command.Param4.ToString();
                    vars[4] = Bits.GetShort(command.Data, 5).ToString("X4");
                    break;
                case 0x3D:
                case 0xE8:
                case 0xEA:
                ...
                case 0x42:
                    ...
                    break;
                case 0x40:
                    vars[0] = (Bits.GetShort(command.Data, 1) & 0xFFF).ToString();
                    vars[1] = ((command.Param2 & 0x20) == 0x20) ? "return on exit" : "...";
                    break;
                case 0x44:
                case 0x45:
                    vars[0] = (Bits.GetShort(command.Data, 1) & 0xFFF).ToString();
                    vars[1] = ((command.Param2 >> 6) * 2 + 0x701C).ToString("X4");
                    break;
                case 0x46:
                case 0x47:
                    vars[0] = (command.Param1 * 2 + 0x701C).ToString("X4");
                    break;
                case 0xD0:
                case 0xD1: vars[0] = (Bits.GetShort(command.Data, 1) & 0xFFF).ToString(); break;
                case 0x4B: vars[0] = WorldMaps.Model.Locations[command.Param1].ToString(); break;
                case 0x4C: vars[0] = Lists.Numerize(Lists.Shops, command.Param1); break;
                case 0x4F:
                case 0x52:
                case 0x53:
                case 0x72:
                ...
                case 0x77:
                case 0xD4:
                    vars[0] = command.Param1.ToString(); break;
                case 0xF0:
                    vars[0] = (command.Param1 + 1).ToString(); break;
                case 0x4A:
                    vars[0] = command.Param1.ToString();
                    vars[1] = command.Param3.ToString("d2");
                    break;
                case 0x50:
                case 0x51:
                    vars[0] = Items.Model.Names.NumerizeUnsorted(command.Param1) + "\"";
                    break;
                case 0x54:
                    vars[0] = CharacterNames[command.Param1];
                    vars[1] = Items.Model.Names.NumerizeUnsorted(command.Param2) + "\"";
                    break;
                case 0x4E:
                    vars[0] = Lists.Menus[command.Param1];
                    switch (command.Param1)
                    {
                        case 5: vars[0] += " (toss item: " + Items.Model.Names.NumerizeUnsorted(command.Param2) + ")"; break;
                        case 7: vars[0] += " (" + TutorialNames[command.Param2] + ")"; break;
                        case 8:
                        case 13: vars[0] += " #" + command.Param2; break;
                        case 16: vars[0] += " (" + EventNames[command.Param2] + ")"; break;
                    }
                    break;
                case 0x56: vars[0] = CharacterNames[command.Param1 & 0x1F]; break;
                case 0x60:
                    vars[0] = "{" + (Bits.GetShort(command.Data, 1) & 0xFFF).ToString() + "}  " +
                        "\"" + Dialogues.Model.Dialogues[Bits.GetShort(command.Data, 1) & 0xFFF].GetStub(true, Dialogues.Model.DTEStr(true)) + "\"";
                    vars[1] = (command.Param2 & 0x80) == 0x80 ? "async" : "sync";
                    vars[2] = (command.Param2 & 0x20) == 0x20 ? "closable" : "unclosable";
                    vars[3] = (command.Param3 & 0x80) == 0x80 ? "BG on" : "BG off";
                    vars[4] = (command.Param3 & 0x40) == 0x40 ? "multi-line" : "single-line";
                    break;
                case 0x61:
                    vars[0] = (command.Param1 & 0x80) == 0x80 ? "async" : "sync";
                    vars[1] = (command.Param1 & 0x20) == 0x20 ? "closable" : "unclosable";
                    vars[2] = (command.Param2 & 0x80) == 0x80 ? "BG on" : "BG off";
                    vars[3] = (command.Param2 & 0x40) == 0x40 ? "multi-line" : "single-line";
                    break;
                case 0x62:
                    vars[0] = "{" + (Bits.GetShort(command.Data, 1) & 0xFFF).ToString() + "}  " +
                        "\"" + Dialogues.Model.Dialogues[Bits.GetShort(command.Data, 1) & 0xFFF].GetStub(true, Dialogues.Model.DTEStr(true)) + "\"";
                    vars[1] = (command.Param2 & 0x80) == 0x80 ? "asynchronous" : "synchronous";
                    switch ((command.Param2 & 0x60) >> 5)
                    {
                    ...
                    break;
                case 0x63:
                    vars[0] = (command.Param1 & 0x80) == 0x80 ? "asynchronous" : "synchronous";
                    vars[1] = (command.Param1 & 0x20) == 0x20 ? "closable" : "unclosable";
                    break;
                case 0x66:
                case 0xD2:
                case 0xD3:
                case 0xDB:
                case 0xDF: vars[0] = (Bits.GetShort(command.Data, 1)).ToString("X4"); break;
                case 0x67:
                    vars[0] = (Bits.GetShort(command.Data, 1)).ToString("X4");
                    vars[1] = (Bits.GetShort(command.Data, 3)).ToString("X4");
                    break;
                case 0x68:
                    vars[0] = Lists.Numerize(Lists.Areas, Bits.GetShort(command.Data, 1) & 0x1FF);
                    vars[1] = command.Param3.ToString();
                    vars[2] = command.Param4.ToString();
                    vars[3] = (command.Param5 & 0x1F).ToString();
                    vars[4] = DirectionNames[((command.Param5 & 0xE0) >> 5)];
                    vars[5] = (command.Param2 & 0x80) == 0x80 ? "run entrance event" : "no entrance event";
                    vars[6] = (command.Param2 & 0x08) == 0x08 ? "show message" : "no message";
                    break;
                case 0x6A:
                case 0x6B:
                    vars[0] = Lists.Numerize(Lists.Areas, Bits.GetShort(command.Data, 1) & 0x1FF);
                    vars[1] = ((command.Param2 & 0x3F) >> 1).ToString();
                    if (command.Opcode == 0x6A)
                        vars[2] = (command.Param2 & 0x80) == 0x80 ? "use alternate mod" : "...";
                    else
                        vars[2] = (command.Param2 & 0x80) == 0x80 ? "permanent" : "temporary";
                    break;
                case 0x78:
                case 0x79:
                    vars[0] = ColorNames[command.Param2];
                    vars[1] = "duration = " + command.Param1.ToString();
                    break;
                case 0x80:
                    vars[0] = Bits.GetShort(command.Data, 1).ToString("X4");
                    vars[1] = Bits.GetString(command.Param3, LayerNames, 8);
                    vars[2] = command.Param4.ToString();
                    break;
                case 0x81:
                    vars[0] = Bits.GetString(command.Param1, LayerNames, 8);
                    vars[1] = Bits.GetString(command.Param2, LayerNames, 8);
                    vars[2] = Bits.GetString(command.Param3, LayerNames, 8);
                    break;
                case 0x83:
                    vars[0] = ColorNames[command.Param1];
                    break;
                case 0x84:
                    vars[0] = Bits.GetString(command.Param1, LayerNames, 4);
                    vars[1] = ((command.Param1 & 0xF0) >> 4).ToString();
                    vars[2] = (command.Param2 & 0x3F).ToString();
                    break;
                case 0x89:
                    switch ((command.Param1 & 0xE0) >> 5)
                    {
                    ...
                    vars[3] = (command.Param1 & 0x0F).ToString();
                    break;
                case 0x8A:
                    vars[0] = command.Param2.ToString();
                    vars[1] = (((command.Param1 & 0xF0) / 16) + 1).ToString();
                    break;
                case 0x87:
                case 0x8F:
                    vars[0] = ObjectNames[command.Param1];
                ...
                case 0x91:
                case 0x92:
                    vars[0] = Lists.Numerize(Lists.SPCTracks, command.Param1);
                    break;
                case 0x95:
                    vars[0] = command.Param1.ToString();
                    vars[1] = command.Param2.ToString();
                ...
                case 0x9E:
                    ...
                    break;
                case 0x97:
                    vars[0] = (command.Param2 & 0x80) == 0x80 ? "Speed up" : "Slow down";
                    vars[1] = Math.Abs((sbyte)command.Param2).ToString();
                    vars[2] = command.Param1.ToString();
                    break;
                case 0x98:
                    vars[0] = (command.Param2 & 0x80) == 0x80 ? "Lower" : "Raise";
                    vars[1] = Math.Abs((sbyte)command.Param2).ToString();
                    vars[2] = command.Param1.ToString();
                    break;
                case 0x9C:
                ...
                case 0xF3:
                    ...
                    if (command.Opcode == 0xF2)
                        vars[2] = (command.Param2 & 0x80) == 0x80 ? "Summon" : "Remove";
                    else
                        vars[2] = (command.Param2 & 0x80) == 0x80 ? "Enable" : "Disable";
                    break;
                case 0xF8:
                    vars[0] = ObjectNames[((command.Param2 >> 1) & 0x3F)];
                    vars[1] = Bits.GetBit(command.Param2, 7) ? "present" : "absent";
                    vars[2] = Lists.Numerize(Lists.Areas, (Bits.GetShort(command.Data, 1) & 0x1FF));
                    vars[3] = Bits.GetShort(command.Data, 3).ToString("X4");
                    break;
                case 0xFD: return ParseCommandFD(command);
                default:
                    if (command.Opcode <= 0x2F)
                    {
                        switch (command.Param1)
                        {
                            case 0xF0:
                            case 0xF1:
                                vars[0] = (command.Param2 & 0x80) == 0x80 ?
                                    "start embedded action script (async)" :
                                    "start embedded action script (sync)";
                                break;
                            case 0xF2:
                                vars[0] = "action script = #" +
                                    Bits.GetShort(command.Data, 2).ToString() +
                                    " (sync)";
                                break;
                            case 0xF3:
                                vars[0] = "action script = #" +
                            ...
                            case 0xF7: vars[0] = "summon to current area @ Mario's coords"; break;
                            case 0xF8: vars[0] = "summon to current area"; break;
                            case 0xF9: vars[0] = "remove from current area"; break;
                            ...
                            default:
                                vars[0] = "action queue (" +
                                    ((command.Param1 & 0x80) == 0x80 ? "async" : "sync") +
                                    ")";
                                break;
                        }
                    }
            ...
            string text = EventCommands[command.Opcode];
            if (text == "")
                text = "{{" + BitConverter.ToString(command.Data) + "}}";
            return string.Format(text, vars);
        }
        private static string ParseCommandFD(EventCommand command)
        {
            string[] vars = new string[16];
            switch (command.Param1)
            {
                ...
                case 0x34:
                case 0x3D:
                    vars[0] = ObjectNames[command.Param2];
                    vars[1] = Bits.GetShort(command.Data, 3).ToString("X4");
                    break;
                case 0x3E:
                    vars[0] = Lists.NPCPackets[command.Param2];
                    vars[1] = Bits.GetShort(command.Data, 3).ToString();
                    vars[2] = Bits.GetShort(command.Data, 5).ToString("X4");
                    break;
                case 0x46:
                    vars[0] = Bits.GetShort(command.Data, 2).ToString();
                    break;
                case 0x4C:
                    vars[0] = Lists.Tutorials[command.Param2];
                    break;
                case 0x4D:
                    vars[0] = command.Param2.ToString();
                    break;
                ...
                case 0x9D:
                    ...
                    break;
                case 0x9E:
                    vars[0] = Lists.Numerize(Lists.SPCTracks, command.Param2);
                    break;
                case 0x58:
                    vars[0] = Items.Model.Names.NumerizeUnsorted(command.Param2);
                    break;
                case 0x5D:
                    switch (command.Param3 & 0x03)
                    {
                        case 0x01: vars[0] = "armor"; break;
                        case 0x02: vars[0] = "accessory"; break;
                        default: vars[0] = "weapon"; break;
                    }
                    vars[1] = CharacterNames[command.Param2 & 0x0F];
                    break;
                case 0x66:
                    ...
                    vars[1] = command.Param1.ToString();
                    break;
                case 0x94:
                    vars[0] = Bits.GetString(command.Param2, null, 8);
                    break;
                case 0x96:
                case 0x97:
                    vars[0] = command.Param2.ToString();
                ...
                case 0xA9:
                case 0xAA:
                    vars[0] = (((((command.Param1 * 0x100) + command.Param2) - 0xA800) / 8) + 0x7040).ToString("X4");
                    vars[1] = (command.Param2 & 0x07).ToString();
                    break;
                case 0xAC:
                    vars[0] = (Bits.GetShort(command.Data, 2) + 0xF800).ToString("X4");
                    break;
                case 0xB0:
                case 0xB1:
                case 0xB2:
                ...
                case 0xB6:
                    ...
                    break;
                case 0xF0:
                    vars[0] = ObjectNames[((command.Param3 >> 1) & 0x3F)];
                    vars[1] = Bits.GetBit(command.Param3, 7) ? "enabled" : "disabled";
                    vars[2] = Lists.Numerize(Lists.Areas, (Bits.GetShort(command.Data, 2) & 0x1FF));
                    vars[3] = Bits.GetShort(command.Data, 4).ToString("X4");
                    break;
                default:
                    break;
            }
            string text = EventCommandsFD[command.Param1];
            if (text == "")
                text = "{{" + BitConverter.ToString(command.Data) + "}}";
            return string.Format(text, vars);
        }
        public static string ParseScript(EventScript eventScript, int lines, int length)
        {
