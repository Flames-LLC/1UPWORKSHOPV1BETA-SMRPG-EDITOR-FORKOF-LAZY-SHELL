...
namespace LazyShell.EventScripts
{
    public static partial class Parser
    {
        ...
        private static readonly string[] ActionCommands = new string[]
        {
            #region 0x00-0x3F
            "Visibility on",			// 0x00
            "Visibility off",			// 0x01
            ...
            "Collision bits = {0}",			// 0x0A
            "Set collision bits {0}",			// 0x0B
            "Clear collision bits {0}",			// 0x0C
            "Palette row = {0}",			// 0x0D
            "Palette row += {0}",			// 0x0E
            "Palette row += 1",			// 0x0F
            ...
            "{0}'s presence in area {1}; is {2}",			// 0xF2
            "{0}'s event trigger in area {1}; is {2}",			// 0xF3
            ...
            "If {0} is present in area {1}; jump to ${2}",			// 0xF8
            "",			// 0xF9
            "",			// 0xFA
            "",			// 0xFB
            "",			// 0xFC
        ...
        private static readonly string[] ActionCommandsFD = new string[]
        {
            #region 0x00-0x3F
            "Shadow on",			// 0x00
            "Shadow off",			// 0x01
        ...
        private static readonly string[] ObjectSpeeds = new string[]
        {
            "normal",
            "fast","faster",
            "very fast", "fastest",
