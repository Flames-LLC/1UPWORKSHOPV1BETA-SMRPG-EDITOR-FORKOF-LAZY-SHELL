...
namespace LazyShell.Audio
{
    ...
    public static class Parser
    {
        ...
        public static string ParseCommand(Command ssc)
        {
            ...
            switch (ssc.Opcode)
            {
                case 0xCD:
                case 0xCE:
                    if (ssc.Type != ElementType.SPCBattle)
                        vars[0] = Lists.Numerize(Lists.SPCEventSounds[ssc.Param1], ssc.Param1, 3);
                    else
                        vars[0] = Lists.Numerize(Lists.SPCBattleSounds[ssc.Param1], ssc.Param1, 3);
                    break;
                case 0xC6:
                case 0xC8:
                case 0xD1:
                ...
                case 0xF6:
                    ...
                    break;
                case 0xDE:
                    vars[0] = Lists.Numerize(Lists.Samples[ssc.Param1], ssc.Param1, 3);
                    break;
                case 0xDF:
            ...
            string command = commands[ssc.Opcode];
            if (command == "")
                command = "UNKSPCCMD {{" + BitConverter.ToString(ssc.Data) + "}}";
