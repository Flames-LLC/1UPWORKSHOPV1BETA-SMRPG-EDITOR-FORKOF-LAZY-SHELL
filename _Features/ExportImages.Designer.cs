...
namespace LazyShell
{
    partial class ExportImages
    {
        ...
        private void InitializeComponent()
        {
			...
			this.oneSpriteSheet.CheckedChanged += new System.EventHandler(this.oneSpriteSheet_CheckedChanged);
			// 
			// oneImageCropped
			// 
			...
			this.maximumWidth.Location = new System.Drawing.Point(174, 79);
