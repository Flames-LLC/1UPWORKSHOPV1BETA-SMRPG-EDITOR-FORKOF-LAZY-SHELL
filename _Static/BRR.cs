...
namespace LazyShell
{
    ...
    public static class BRR
    {
        ...
        private static short p1, p2;

        // Encoder variables
        private static bool[] FIRen;
        private static int[] FIRstats;
        private static byte[] BRRBuffer;
        private static double resample_var;
        private static char resample_type;
        ...
        {	//Decode a string of BRR bytes
            ...
            var output = new short[(Data.Length - 1) << 1];					//Output string of 16-bit samples
        ...
        private static void DecodeSample(byte s, int ShiftAmount, int Filter)
        {
        ...
        private static short[] Append(short[] t1, short[] t2)
        ...
        private static void ADPCMBlockMash(short[] PCMData)
        {
            int smin = 0;
            int kmin = 0;
        ...
        private static double ADPCMMash(int shiftamount, int filter, short[] PCMData, bool write)
        {
            int d;
            double d2 = 0.0;
            int vlin = 0;
        ...
        private static short Clamp_16(int n)
        {
            if ((short)n != n)
                n = (short)(0x7FFF - (n >> 24));
            return (short)n;
        }
        private static short[] Resample(short[] samples, char type)
        {
        ...
        private static short[] SNES_interpolate(short[] samples, int pitch)
        {
        ...
        private static readonly int[] gauss = new int[]
        {
